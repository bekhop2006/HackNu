...
interface CryptoKZLogoProps {
  size?: number;
  withAccent?: boolean;
}

export default function CryptoKZLogo({ size = 80, withAccent = true }: CryptoKZLogoProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 240 280" fill="none">
      <Defs>
        <LinearGradient id="solarGlow" x1="0%" y1="0%" x2="100%" y2="100%">
          <Stop offset="0%" stopColor={CryptoKZColors.solar} stopOpacity="0.6" />
          <Stop offset="100%" stopColor={CryptoKZColors.solar} stopOpacity="0.2" />
        </LinearGradient>
      </Defs>
      <G>
        {/* Top left square */}
        <Path
          ...
          stroke={CryptoKZColors.persianGreen}
          strokeWidth="7"
          fill="none"
          strokeLinecap="round"
        ...
        <Path
          ...
          stroke={withAccent ? CryptoKZColors.solar : CryptoKZColors.persianGreen}
          strokeWidth="7"
